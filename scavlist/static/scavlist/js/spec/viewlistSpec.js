describe("List view", function() {
  ...
  it("makes the rows", function() {
    ...
    visibleRows = listView.rows.filter(function(rowView){
  ...
  it("filters by text", function() {
    ...
    listView.filterBy("text", "A copy of the 2015");
    visibleRows = listView.rows.filter(function(rowView){
      return !rowView.tag[0].hidden;
    });
  ...
  it("filters by point value", function(){
    listView.filterBy("points", [1, 2]);
    visibleRows = listView.rows.filter(function(rowView){
      return !rowView.tag[0].hidden;
    });
